...
class api:
    ...
    def __init__(self, configuration, ip=None, username=None, password=None):
        ...
        if ip:
           self.baseurl = "https://" + ip + "/api/v1"
            ...
            self.baseurl = "https://" + configuration.system_ip + "/api/v1"

        if username:
            self.username=username
        else:        
            self.username = configuration.gui_username
        
        if password:
            self.password=password
        else:        
            self.password = configuration.gui_password
    ...
    def get_jobs(self):
        ...
        if (response.status_code != 200):                     
            pytest.fail("Unexpected status geting projects : " + str(response.status_code)) 
    ...
    def delete_job(self, job_id):
        ...
        if (response.status_code != 204):                     
            pytest.fail("Unexpected status code deleting project : " + str(response.status_code))
    ...
    def create_job(self,
            ...
            if (response.status_code != 200): 
                ...
                pytest.fail("Unexpected status code adding job : " + str(response.status_code) + " " + str(respons.reason))
    ...
    def update_job(self, job_id, label, source, destination, encrypt=True):
        ...
        if (response.status_code != 200):                     
            pytest.fail("Unexpected status code updating job : " + str(response.status_code))
    ...
    def start_job(self, job_id, verify_migration):
        ...
        url = self.baseurl + "/datamovement/jobs/" + str(job_id) + "/start" + verify_str
    ...
    def update_project(self, project_id, 
        ...
        if (response.status_code != 200):                     
            pytest.fail("Unexpected status code updating project : " + str(response.status_code))
    ...
    def create_project(self, name, jobrunlimit=None, defaultmigjobrate=None):
        ...
        response = requests.post(url, 
                                ...
                                verify=False) 
        if (response.status_code != 200):                     
            pytest.fail("Unexpected status code adding project : " + str(response.status_code + " " + str(response.content)))
    ...
    def delete_project(self, project_id):
        ...
        if (response.status_code != 204):                     
            pytest.fail("Unexpected status code deleting project : " + str(response.status_code) + " " + str(response.content))
